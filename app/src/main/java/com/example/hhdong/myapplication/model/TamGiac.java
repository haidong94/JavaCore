...
public class TamGiac {
    ...
    public void VeTamGiacBai6(){
        for(int i=chieuCao;i>0;i--){
            System.out.print("\n");
            for(int j=0;j<(chieuCao-i)*2+1;j++)
            {
                if(j%2!=0)
                    System.out.print("*");
                else
                    if(j!=(chieuCao-1)*2)
                        System.out.print(chieuCao - i + 1);
        ...
        for(int i=1;i<chieuCao;i++){
            ...
            for(int j=0;j<(chieuCao-i)*2-1;j++)
            {
                if(j%2!=0)
                    ...
                    System.out.print(chieuCao-i);
            }
        }
    }

    public void VeTamGiacBai7(){
        for(int i=0;i<chieuCao;i++){
